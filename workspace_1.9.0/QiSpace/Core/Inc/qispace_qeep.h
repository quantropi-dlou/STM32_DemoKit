...
/*
    Load IV to encrypt or decrypt, which is a 16 byte random number
    Input parameters:
...
/*
    QEEP decrypt de can be used for an ciphertext of any length by calling this API multiple times
    Divide the message into sections (multiple of 16), the last section can be any length (less than 16)
    Input parameters:
        - QP: QP_handle created by QP_init
